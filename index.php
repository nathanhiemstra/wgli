...
mysql_select_db($database_wgli_admin, $wgli_admin);
$query_event = sprintf("SELECT *, UNIX_TIMESTAMP(when_start) AS unixdate_when_start, UNIX_TIMESTAMP(when_end) AS unixdate_when_end FROM events WHERE when_start > %s ORDER BY when_start ASC", GetSQLValueString($colname_event, "date"));
...
<div id="main">
	...
	<div class="home-definition">
		...
		<p>ACA is not limited to those from alcoholic homes. If you identify with <a href="/is-aca-for-me/#laundry-list-anchor">traits from this list</a>, ACA will benefit you.</p>
	...
	<div class="home-event-callout">
		...
		<ul class="list-no-indent">
			<li>
				...
				<ul class="list-normal list-secondary  list-normal-size list-single-space "> 
				  <li><a href="#meeting-id-28" id="meeting-id-28-cta">Hyde Park&ndash; Saturday, 9am</a></li>
				  <li><a href="#meeting-id-26" id="meeting-id-26-cta">4th Step Workbook Group<br> Lincoln Square &ndash; Thursday, 7pm</a></li>
				  <li><a href="#meeting-id-27" id="meeting-id-27-cta">Orland Park &ndash; Tuesday, 7pm</a></li>
				</ul>
			</li>


			<li>
				<p>Please add our website to your meeting's phone lists: <strong>westgreatlakesaca.org</strong>
			...
			<li>
				...
				Intergroup committees: Hospitals &amp; Institutions, Outreach, Events, and Website.    
				<br /><a href="mailto:chair@westgreatlakesaca.org">Get involved</a>
				</p>
			...
			<li>
				...
				Dec. 15, 1-3pm, conference call:<br /> 
				530-881-1300, pass code 434291<br /> 
				Visitors welcome
			</p>
			</li>
		</ul>
		...
		<ul class="list-no-indent">
			...
			<li>
				<p>Contributions needed for:</p>
				<ul  class="list-normal list-secondary  list-normal-size list-single-space ">
					<li><p><a href="http://adultchildren.org/meditation.php" target="_blank">Meditation book project</p></a></li>
					<li><p><a href="http://www.adultchildren.org/abc2012/" target="_blank">Brochures on “crosstalk” and “developing group solidarity”</a> </p></li>
				</ul>
			</li>	

			<li>
				<p>Over 1150 ACA meetings world wide!</p>
			</li>
